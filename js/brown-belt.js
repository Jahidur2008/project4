...
const tableBody =
  document.getElementById("brownBeltTableBody");

const totalBrownStudents =
  document.getElementById("totalBrownStudents");
...
onAuthStateChanged(auth, (user) => {
  ...
  loadBrownBeltStudents();

});


// =========================================
// LOAD BROWN BELT STUDENTS
// =========================================

async function loadBrownBeltStudents() {

  if (!tableBody) {

    console.error(
      "brownBeltTableBody not found."
    );
...
function updateStats(students) {
  ...
  if (totalBrownStudents) {

    totalBrownStudents.textContent =
      students.length;
...
function updateResultPreview() {
  ...
  if (mark >= 40) {
    ...
    resultPreview.textContent =
      "PASS — Student will be promoted to Black Belt";
    ...
    resultPreview.textContent =
      "FAIL — Student will remain in Brown Belt";
...
async function saveExamResult() {
  ...
  try {
    ...
    if (result === "PASS") {
      ...
      alert(
        "Exam passed! Student has been promoted to Black Belt."
      );

    } else {

      alert(
        "Exam result saved. Student remains in Brown Belt."
      );
