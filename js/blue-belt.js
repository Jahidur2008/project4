...
const tableBody =
  document.getElementById("blueBeltTableBody");

const totalBlueStudents =
  document.getElementById("totalBlueStudents");
...
onAuthStateChanged(auth, (user) => {
  ...
  loadBlueBeltStudents();
});

/* =========================================
   LOAD BLUE BELT STUDENTS
========================================= */

async function loadBlueBeltStudents() {

  if (!tableBody) {
    console.error("blueBeltTableBody not found.");
    return;
  }
...
function updateStats(students) {
  ...
  if (totalBlueStudents) {
    totalBlueStudents.textContent =
      students.length;
  }
...
function updateResultPreview() {
  ...
  if (mark >= 40) {
    ...
    resultPreview.textContent =
      "PASS — Student will be promoted to Brown Belt";
    ...
    resultPreview.textContent =
      "FAIL — Student will remain in Blue Belt";
...
async function saveExamResult() {
  ...
  try {
    ...
    if (result === "PASS") {
      ...
      alert(
        "Exam passed! Student has been promoted to Brown Belt."
      );

    } else {

      alert(
        "Exam result saved. Student remains in Blue Belt."
      );
    }

    closeExamModal();

    await loadBlueBeltStudents();
