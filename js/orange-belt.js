...
const tableBody =
  document.getElementById("orangeBeltTableBody");

const totalOrangeStudents =
  document.getElementById("totalOrangeStudents");
...
onAuthStateChanged(auth, (user) => {
  ...
  loadOrangeBeltStudents();
});

/* =========================================
   LOAD ORANGE BELT STUDENTS
========================================= */

async function loadOrangeBeltStudents() {

  if (!tableBody) {
    console.error("orangeBeltTableBody not found.");
    return;
  }
...
function updateStats(students) {
  ...
  if (totalOrangeStudents) {
    totalOrangeStudents.textContent =
      students.length;
  }
...
function updateResultPreview() {
  ...
  if (mark >= 40) {
    ...
    resultPreview.textContent =
      "PASS — Student will be promoted to Green Belt";
    ...
    resultPreview.textContent =
      "FAIL — Student will remain in Orange Belt";
...
async function saveExamResult() {
  ...
  try {
    ...
    if (result === "PASS") {
      ...
      alert(
        "Exam passed! Student has been promoted to Green Belt."
      );

    } else {

      alert(
        "Exam result saved. Student remains in Orange Belt."
      );
