...
const tableBody =
  document.getElementById("greenBeltTableBody");

const totalGreenStudents =
  document.getElementById("totalGreenStudents");
...
onAuthStateChanged(auth, (user) => {
  ...
  loadGreenBeltStudents();

});

/* =========================================================
   LOAD GREEN BELT STUDENTS
========================================================= */

async function loadGreenBeltStudents() {

  if (!tableBody) {
    console.error("greenBeltTableBody not found.");
    return;
  }
...
function updateStats(students) {
  ...
  if (totalGreenStudents) {

    totalGreenStudents.textContent =
      students.length;
...
function updateResultPreview() {
  ...
  if (mark >= 40) {
    ...
    resultPreview.textContent =
      "PASS — Student will be promoted to Blue Belt";
    ...
    resultPreview.textContent =
      "FAIL — Student will remain in Green Belt";
...
async function saveExamResult() {
  ...
  try {
    ...
    if (result === "PASS") {
      ...
      alert(
        "Exam passed! Student has been promoted to Blue Belt."
      );

    } else {

      alert(
        "Exam result saved. Student remains in Green Belt."
      );
