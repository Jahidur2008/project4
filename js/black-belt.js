...
const tableBody =
  document.getElementById("blackBeltTableBody");

const totalBlackStudents =
  document.getElementById("totalBlackStudents");
...
onAuthStateChanged(auth, (user) => {
  ...
  loadBlackBeltStudents();
});

// =====================================================
// LOAD BLACK BELT STUDENTS
// =====================================================

async function loadBlackBeltStudents() {

  if (!tableBody) {
    console.error(
      "blackBeltTableBody not found."
    );
    return;
  }
...
// =====================================================
// GET BROWN BELT EXAM MARK
// =====================================================
//
// প্রথমে সরাসরি brownBeltExamMark খুঁজবে।
//
// যদি সেটা না থাকে, তাহলে beltHistory থেকে
// Brown Belt PASS-এর mark খুঁজবে।
//
// এতে পুরোনো student-এর data-ও কাজ করবে।
// =====================================================

function getBrownBeltExamMark(student) {

  // নতুন field
  if (
    student.brownBeltExamMark !==
      undefined &&
    student.brownBeltExamMark !==
      null
  ) {

    return student.brownBeltExamMark;
  }

  // beltHistory থেকে খোঁজা
  if (
    Array.isArray(
      student.beltHistory
    )
...
function renderStudents(students) {
  ...
  students.forEach(
    (student, index) => {
      ...
      let resultHTML = `
        <span
          class="result-badge result-brown-pass"
        >
          BROWN BELT PASS
        </span>
      `;
      ...
      row.innerHTML = `
        ...
        <td>
          ...
          <span
            class="belt-badge black-belt-badge"
          >
            Black Belt
          </span>
...
function updateStats(students) {
  ...
  if (totalBlackStudents) {

    totalBlackStudents.textContent =
      students.length;
  }

  // Black Belt exam দেওয়া হয়েছে
  const examined =
    students.filter(
      (student) => {
...
function updateResultPreview() {
  ...
  if (mark >= 40) {
    ...
    resultPreview.textContent =
      "PASS — Student will receive Black Belt Pass";
    ...
    resultPreview.textContent =
      "FAIL — Student can take the Black Belt exam again";
...
async function saveExamResult() {
  ...
  try {
    ...
    // =================================================
    //
    // Brown Belt mark untouched
    //
    // Black Belt mark আলাদা field
    //
    // Give Mark থাকবে
    // =================================================
    ...
    if (
      ...
      alert(
        "Black Belt exam result saved. Student failed and can be examined again."
      );
    }
    ...
    // Brown Belt mark untouched
    //
    // Black Belt mark save
    //
    // Result = BLACK BELT PASS
    //
    // Give Mark automatically disappear
    //
    // Get Testimonial automatically appear
    // =================================================
    ...
    if (
      ...
      alert(
        "Congratulations! Student has passed the Black Belt examination."
      );
    }
    ...
    await loadBlackBeltStudents();

  } catch (error) {

    console.error(
      "Save Black Belt Exam Error:",
      error
    );
...
// =====================================================
//
// এখন শুধু button কাজ করছে কিনা দেখানোর জন্য।
// তুমি পরে testimonial-এর actual কাজ বলবে,
// তখন এখানে সেটি বসানো যাবে.
// =====================================================
